...
class FluxAndMonoGeneratorServiceTest {
    ...
    @Test
    void explorerMerge(){
        var nameFlux = fluxAndMonoGeneratorService.explorerMerge();
        StepVerifier.create(nameFlux)
                .expectNext("a", "b", "c", "d", "e", "f")
                .verifyComplete();
    }
    ...
    @Test
    void explorerMergeWith(){
        var nameFlux = fluxAndMonoGeneratorService.explorerMergeWith();
        StepVerifier.create(nameFlux)
                .expectNext("a", "b", "c", "d", "e", "f")
                .verifyComplete();
    }
    ...
    @Test
    void explorerMergeWithMono() {
        var nameFlux = fluxAndMonoGeneratorService.explorerMergeWithMono();
        StepVerifier.create(nameFlux)
                .expectNext("a", "b")
                .verifyComplete();
    }
    ...
    @Test
    void explorerMergeSeq(){
        var nameFlux = fluxAndMonoGeneratorService.explorerMergeSeq();
        StepVerifier.create(nameFlux)
                .expectNext("a", "b", "c", "d", "e", "f")
                .verifyComplete();
    }
    ...
    @Test
    void explorerZip(){
        var nameFlux = fluxAndMonoGeneratorService.explorerZip();
        StepVerifier.create(nameFlux)
                .expectNext("ad", "be", "cf")
                .verifyComplete();
    }
    ...
    @Test
    void explorerZipMore(){
        var nameFlux = fluxAndMonoGeneratorService.explorerZipMore();
        StepVerifier.create(nameFlux)
    ...
    @Test
    void explorerZipWith(){
        var nameFlux = fluxAndMonoGeneratorService.explorerZipWith();
        StepVerifier.create(nameFlux)
                .expectNext("ad", "be", "cf")
                .verifyComplete();
    }
